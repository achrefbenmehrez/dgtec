                ...
                <div wire:id="uKnDWrKeCr7Od9vR1Ecs" class="grid items-center w-full grid-cols-2 gap-4 text-white"
                    ...
                    <div class="grid items-center justify-between w-full grid-cols-1 gap-4 xl:grid-cols-5 col-span-full">
                        ...
                        <div class="flex col-span-full">
                            ...
                            <button class="button group --has-trailing ml-auto   --is-small" wire:loading.class="--is-loading">


                                <span class="button__caption">
                                    <span class="w-full">Demande de retour</span>
                                </span>
                        ...
                        <div class="w-full col-span-full xl:col-span-1 xl:col-start-4">
                            ...
                            <input
                                ...
                                placeholder="website/customer_area/livewire/rmas/listing.actions.monthfilter"
                        ...
                        <div class="w-full col-span-full xl:col-span-1">
                            ...
                            <input
                                ...
                                placeholder="Ex: n° rma, référence produit, ...">
                        </div>
                    </div>
                    ...
                    <div class="relative mt-4 overflow-y-auto col-span-full" wire:loading.class="hidden"
                        ...
                        <table class="w-full mb-4 text-dark">
                            <tbody>
                                @if (count($savs) > 0)
                                    <tr class="text-xs font-semibold tracking-wide text-left text-dark uppercase border-b">
                                        <th class="px-4 py-3">N° RMA</th>
                                        <th class="px-4 py-3">Date</th>
                                        <th class="px-4 py-3">Nom Produit</th>
                                        <th class="px-4 py-3">Raison Sociale societe</th>
                                        ...
                                        <tr>
                                            <td>
                                                <div
                                                    ...
                                                    <span class="mt-4 text-sm">{{ $sav->numero }}</span>
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <div
                                                    class="flex flex-col items-center justify-center w-full mb-16 bg-secondary-700">
                                                    <span class="mt-4 text-sm">{{ $sav->created_at }}</span>
                                                </div>
                                            </td>
                                ...
                                @else
                                    <tr>
                                        <td colspan="5">
                                            <div
                                                class="flex flex-col items-center justify-center w-full mb-16 bg-secondary-700">
                                                <span class="mt-4 text-sm">Aucun RMA</span>
                                            </div>
                                        </td>
                                    </tr>
                                @endif
                    ...
                    <div class="relative hidden overflow-y-hidden col-span-full h-96" wire:loading.class.remove="hidden"
                        wire:target="month,search">
                        <div class="loader-payment">
                            <div class="loader-loading">Chargement...</div>
                        </div>
                    </div>

                </div>

                <!-- Livewire Component wire-end:uKnDWrKeCr7Od9vR1Ecs -->
            </div>
        </div>
    </div>
@endsection
