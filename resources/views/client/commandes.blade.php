        ...
        <div class="grid grid-cols-4">
            ...
            <div class="px-4 col-span-full lg:col-span-3">
                <div wire:id="tATkGPf26swAQ1xQsBvb" class="grid items-center w-full grid-cols-2 gap-4 text-white"
                    ...
                    <div
                        class="grid items-center justify-between w-full grid-cols-1 gap-4 xl:grid-cols-5 col-span-full text-dark">
                        <div class="flex items-end justify-center h-full pb-4 space-x-8 xl:justify-start xl:col-span-2">
                            <div class="flex items-center">
                                ...
                                <span class="ml-2 text-xs uppercase">livré</span>
                            </div>
                            <div class="flex items-center">
                                <span class="inline-block w-4 h-4 bg-red-400 rounded-full"></span>
                                <span class="ml-2 text-xs uppercase">non livré</span>
                            </div>
                        </div>
                        ...
                        <div class="w-full col-span-full xl:col-span-1 xl:col-start-4">
                            ...
                            <input
                                ...
                                placeholder="website/customer_area/livewire/orders/listing.actions.monthfilter"
                        ...
                        <div class="w-full col-span-full xl:col-span-1">
                            ...
                            <input
                                ...
                                id="search" wire:model="search" type="text" placeholder="Ex: n° commande,...">
                        </div>
                    </div>
                            ...
                            <tbody>
                                ...
                                @if (count($commandes) > 0)
                                    @foreach ($commandes as $commande)
                                        @foreach ($commande['donnees_panier'] as $id => $details)
                                    ...
                                    @foreach ($commandes as $commande)
                                        @foreach ($commande['donnees_panier'] as $id => $details)
                                            <tr>
                                                ...
                                                <th
                                                    class="hidden text-xs font-semibold text-right uppercase sm:table-cell">
                                                    Prix HT
                                                </th>
                                                <th
                                                    class="hidden text-xs font-semibold text-right uppercase sm:table-cell">
                                            ...
                                            <tr
                                                class="border-t-4 border-secondary-700 w-full bg-opacity-75 @if ($commande['etat'] == 'Livré') bg-primary-400
                                                @else
                                                    bg-red-400 @endif">
                                                <td>
                                                    <div
                                                        class="py-4 text-2xl text-center sm:text-base sm:pl-12 sm:text-left text-white">

                                                        {{ $commande['id'] }} <span class="sm:hidden"></span>

                                                        <div class="flex flex-col items-center mt-4 sm:hidden">
                                                            <div class="text-base text-center text-secondary-300">
                                                                <span>
                                                                    {{ $commande['created_at']->format('j F, Y') }}
                                                                </span>
                                                            </div>
                                                            ...
                                                            <div class="px-12 py-4">
                                                                <button type="button" class="flex items-center">
                                                                    <svg class="w-4 h-4"
                                                                        ...
                                                                        class="ml-4 text-sm uppercase sm:sr-only">Voir
                                                                        le
                                                                        panier</span>
                                                                </button>
                                                            </div>
                                                ...
                                                <td class="hidden w-0 sm:table-cell">
                                                    <div class="flex justify-center px-12 py-4">
                                                        <div class="px-4 py-4">
                                                            <button type="button" id="{{ $commande->id }}"
                                                                class="showDetails text-white transition-colors hover:text-primary-500">
                                    ...
                                    <tr>
                                        <td colspan="5">
                                            <div
                                                ...
                                                <span class="mt-4 text-sm">Aucune commande</span>
                                            </div>
                                        </td>
                                    </tr>
                                @endif
                    ...
                    <div class="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="modal-title" role="dialog"
                        ...
                        <div class="flex items-end justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:p-0">
                            ...
                            <div wire:id="QpQCcDRw0c7BbCISlDSz"
                                ...
                                x-show="view_details" @order-opened="view_details=true"
                                ...
                                <div class="px-4 pt-5 pb-4 bg-secondary-700 sm:p-6 sm:pb-4">
                                    ...
                                    <div class="flex flex-wrap justify-between mt-4 space-y-4">
                                        ...
                                        <div class="flex justify-center w-full space-x-2 md:w-auto">
                                            <button class="button group px-4 --is-secondary md:w-auto" type="button"
                                                wire:click="downloadOrderNote([])" wire:target="downloadOrderNote"
                                                wire:loading.class="--is-loading" title="Télécharger le bon de commande">


                                                <span class="button__caption">
                                                    <span class="sr-only">Télécharger le bon de commande</span>
                                                    <svg class="w-6 h-6" transform="scale(-1,1)" fill="currentColor"
                                            ...
                                            <button class="button group px-4 --is-secondary md:w-auto" type="button"
                                                wire:click="downloadQuotation([])" wire:target="downloadQuotation"
                                                wire:loading.class="--is-loading" title="Télécharger le devis">


                                                <span class="button__caption">
                                                    <span class="sr-only">Télécharger le devis</span>
                                            ...
                                            <button class="button group px-4 --is-secondary md:w-auto" type="button"
                                                wire:click="downloadShippingNote([])" wire:target="downloadShippingNote"
                                                wire:loading.class="--is-loading" title="Télécharger le bon de livraison">


                                                <span class="button__caption">
                                                    <span class="sr-only">Télécharger le bon de livraison</span>
                                                    <svg class="w-6 h-6" fill="currentColor"
                                                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                                        <path
                                    ...
                                    <div class="grid grid-cols-1 mt-4 gap-y-6 gap-x-4">
                                        ...
                                        <div class="w-full">
                                            <div class="w-full">
                                                <table id="CommandeDetails" class="hidden w-full rounded md:table"
                                                    style="">
                                                    <tbody>
                                                        <tr>
                                                ...
                                                <table class="w-full">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th class="text-xl text-right"> DT TTC</th>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                                ...
                                <div
                                    ...
                                    <button class="button group --has-trailing   --is-small" id="order-again"
                            ...
                            <!-- Livewire Component wire-end:QpQCcDRw0c7BbCISlDSz -->
                        </div>
                    </div>

                </div>

                <!-- Livewire Component wire-end:tATkGPf26swAQ1xQsBvb -->
            </div>
        </div>
    </div>
    <script>
        $("#showDetails").click(function() {
            $("#CommandeDetails").show();
        })
    </script>
@endsection
