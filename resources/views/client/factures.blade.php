        ...
        <div class="grid grid-cols-4">
            <div class="hidden lg:block lg:col-span-1">
                <a href="{{ route('client.factures') }}" target="_self" rel=""
                    ...
                    <p class="text-xs font-semibold text-center text-white uppercase ">Historique de facture</p>
                </a>
                                ...
                                @if (count($factures) > 0)
                                    @foreach ($factures as $facture)
                                        <tr>
                                            ...
                                            <th
                                                class="hidden text-xs font-semibold text-center uppercase cursor-pointer sm:table-cell  sm:pl-12">
                                            ...
                                            <th class="hidden text-xs font-semibold text-right uppercase sm:table-cell  sm:pl-12">
                                                Total
                                            </th>
                                            <th class="hidden text-xs font-semibold text-right uppercase sm:table-cell  sm:pl-12">
                                                Nom d'utilisateur
                                            ...
                                            <th class="hidden sr-only sm:table-cell  sm:pl-12">Actions</th>
                                        </tr>

                                        <tr
                                            class="border-t-4 border-secondary-700 w-full bg-opacity-75 @if ($facture['etat'] == 'RÉGLÉE') bg-primary-400
                                                @elseif($facture['etat'] == 'EN COURS')
                                                bg-tertiary-400 @else bg-red-400 @endif">
                                            <td>
                                                <div
                                                    class="py-4 text-2xl text-center sm:text-base sm:pl-12 sm:text-left text-white">

                                                    {{ $facture['id'] }} <span class="sm:hidden"></span>
                                                    ...
                                                    <div class="flex flex-col items-center mt-4 sm:hidden">
                                                        ...
                                                        <div class="mt-4 text-xl text-right text-secondary-300">
                                                            <span>
                                                                {{ $facture->created_at->format('j F, Y') }}
                                                            </span>
                                                        </div>
                                                    </div>
                                            ...
                                            <td class="hidden w-0 sm:table-cell">
                                                <div class="flex justify-center px-12 py-4">
                                                    <div class="px-4 py-4">
                                                        <button type="button" id="{{ $facture->id }}"
