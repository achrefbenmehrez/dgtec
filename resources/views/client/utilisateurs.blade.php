                ...
                <div wire:id="XKGetzdtQihB68DJBZSB" class="grid items-center w-full grid-cols-2 gap-4 text-white"
                                ...
                                <tr class="border-t-4 border-secondary-700 w-full bg-secondary-600 bg-opacity-75">
                                    <td>
                                        <div class="flex flex-col py-4 pl-12 pr-12 text-xs sm:block sm:pl-12">
                                            ...
                                            <span class="hidden text-xs sm:block">Nefoussi</span>

                                            <table class="w-full px-12 mx-auto text-sm text-left sm:hidden">
                                                <tbody>
                                                    <tr>
                                                        <th class="w-1/2 px-4 py-2">Nom</th>
                                                        <td class="w-1/2 px-4 py-2">Nefoussi</td>
                                                    </tr>
                                                    <tr>
                                                        <th class="w-1/2 px-4 py-2">Prénom</th>
                                                        <td class="w-1/2 px-4 py-2">Jaafar</td>
                                                    </tr>
                                                    <tr>
                                                        <th class="w-1/2 px-4 py-2">Login</th>
                                                        <td class="w-1/2 px-4 py-2">NefoussiJaafarDGTEC</td>
                                                    </tr>
                                                    <tr>
                                                        <th class="w-1/2 px-4 py-2">Email</th>
                                                        <td class="w-1/2 px-4 py-2">jn@dgtec.tn</td>
                                                    </tr>
                                                    <tr>
                                                        <th class="w-1/2 px-4 py-2">Téléphone</th>
                                                        <td class="w-1/2 px-4 py-2"></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                            ...
                                            <div class="flex items-center justify-center px-12 py-4 sm:hidden">
                                                <div class="px-4 py-4">
                                                    <button type="button" wire:click="editUser(43932)"
                                                        ...
                                                        <span
                                                            class="sr-only">website/customer_area/livewire/users/listing.actions.edit</span>
                                                        <svg wire:loading.class="hidden" wire:target="editUser(43932)"
                    ...
                    <div class="flex col-span-full">
                        <button class="button group --has-trailing ml-auto --is-primary --is-small"
                            wire:click.prevent="addUser" wire:loading.class="--is-loading">
                    ...
                    <div wire:id="YpTpZ4axbBCzHeTFN4qE" class="fixed inset-0 z-50 overflow-y-auto"
                    ...
                    <!-- Livewire Component wire-end:YpTpZ4axbBCzHeTFN4qE -->
                </div>

                <!-- Livewire Component wire-end:XKGetzdtQihB68DJBZSB -->
            </div>
        </div>
    </div>
@endsection
