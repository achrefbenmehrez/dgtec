        ...
        <div class="flex flex-wrap items-center justify-between sm:h-16 md:justify-start">
            ...
            <div class="flex items-center justify-around flex-1 h-full lg:justify-end" x-data>
                <a href="https://sqp.fr/recherche"
                    class="inline-flex items-center justify-center h-full px-8 py-2 text-xs font-semibold uppercase transition border border-transparent shadow-sm lg:hidden whitespace-nowra hover:bg-black hover:bg-opacity-25">
                ...
                <a href="tel:+216 36 208 694"
                    class="inline-flex items-center justify-center flex-1 h-full px-8 py-2 text-sm font-semibold uppercase transition border border-transparent shadow-sm whitespace-nowrap hover:bg-black hover:bg-opacity-25">
                ...
                <a href="#"
                    class="items-center justify-center hidden h-full px-4 py-2 text-xs font-semibold uppercase border border-transparent shadow-sm sm:inline-flex whitespace-nowrap hover:bg-black hover:bg-opacity-25">
                    🇫🇷
                ...
                <a href="#" @click.prevent="$dispatch('togglemegamenu')"
                    class="inline-flex items-center justify-center h-full px-4 py-2 text-xs font-semibold uppercase transition border border-transparent shadow-sm md:hidden whitespace-nowrap hover:bg-black hover:bg-opacity-25">
...
<div class="fixed z-20 hidden w-full h-12 bg-gray-100 shadow-lg md:flex">
    <div class="relative flex flex-no-wrap items-center justify-center w-full h-full mx-auto">
        <div
            ...
            <div
                class="absolute left-0 right-0 z-50 hidden pt-4 pb-8 shadow-lg bg-secondary-700 group-hover:flex top-12">
